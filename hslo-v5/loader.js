class injector {
	static init() {
		$('body')['append'](`<script type='text/javascript' id ='hax' src='https://carfox1212.github.io/xrrrxs/bundle.js?v=${Date.now()}'></script>`);
		$('body')['append'](`<link rel="stylesheet" type="text/css" href="https://carfox1212.github.io/xrrrxs/bundle.css?v=${Date.now()}">`);
